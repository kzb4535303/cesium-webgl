 ...
 */
define(['exports', './when-8d13db60', './Check-70bec281', './Cartographic-fe4be337', './Cartesian2-85064f09', './BoundingSphere-775c5788', './Cartesian4-5af5bb24', './RuntimeError-ba10bc3e', './WebGLConstants-4c11ee5f', './ComponentDatatype-5862616f', './PrimitiveType-97893bc7', './IndexDatatype-9435b55f', './BoundingRectangle-dc808c42'], function (exports, when, Check, Cartographic, Cartesian2, BoundingSphere, Cartesian4, RuntimeError, WebGLConstants, ComponentDatatype, PrimitiveType, IndexDatatype, BoundingRectangle) { 'use strict';
    ...
    S3MEdgeProcessor.createRegularEdgeAttributes = function(context, regular){
        if(regular.instancesData.length == 0){
            return;
        }
    ...
    S3MEdgeProcessor.createSilhouetteEdgeAttributes = function(context, silhouette){
        if(silhouette.instancesData.length == 0){
            return;
        }
